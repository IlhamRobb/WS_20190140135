...
import web.servis.c5.exceptions.NonexistentEntityException;
import web.servis.c5.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("web.servis.c_135_jar_0.0.1-SNAPSHOTPU");;
